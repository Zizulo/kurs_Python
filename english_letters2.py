...
["havoc", "spustoszenie"], ["fog", "mgła"], ["protruding", "wystające"], ["exhibit", "wystawa"], ["barely", "ledwie"], ["incentive", "zachęta"], ["haunted", "nawiedzany"], ["narrow", "węższy"], ["wider", "szerzej"], ["dodge", "unik"], ["leech", "pijawka"], ["fluttering", "trzepotliwy"], ["exceed", "przekroczyć"], ["chamber", "izba"], ["apart", "oddalone"], ["stealth", "podstępny"], ["scorched", "przypalony"], ["embedding", "osadzanie"],
...
["cover", "relacjonować"], ["intimate", "intymne"], ["smithing", "kucie"], ["smith", "kowal"], ["match", "pasować"], ["traces", "ślady"], ["cashing", "spieniężanie"], ["mimic", "imitować"], ["trailer park", "park przyczep kempingowych"], ["conducting", "przeprowadzanie"], ["subspecies", "podgatunek"], ["consistent", "spójny"], ["overall", "ogólnie"], ["accelerate", "przyspieszać"], ["oftentimes", "częstokroć"], ["broadest", "najszerszy"],
["preserve", ["utrwalać", "konserwa"]], ["insights", "spostrzeżenia"], ["rely", "polegać"], ["resilient", "odporny"], ["stand", ["znieść", "osiągnąć", "trybuna"]], ["stands apart", "trzymać się z dala"], ["in terms of", "z punktu widzenia"], ["in lieu of", "zamiast"]]
