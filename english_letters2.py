...
["cover", "relacjonować"], ["intimate", "intymne"], ["smithing", "kucie"], ["smith", "kowal"], ["match", "pasować"], ["traces", "ślady"], ["cashing", "spieniężanie"], ["mimic", "imitować"], ["trailer park", "park przyczep kempingowych"], ["conducting", "przeprowadzanie"], ["subspecies", "podgatunek"], ["consistent", "spójny"]]
